                    ...
                    @foreach($kondisi as $data)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ base_url('SekolahController/lihatKondisi/'.$data->npsn) }}" class="btn btn-sm btn-info"><i class="fa fa-search"></i> Lihat 
                                    @if($this->session->user_login['role'] != 'a01') dan Tambah Kondisi @endif</a>
                            </td>
                        </tr>
                        @endif
                    @endforeach

                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ base_url('SekolahController/uploadKondisi/'.$data->kode_ruang.'/'.$sekolah->npsn) }}" class="btn btn-sm btn-danger"><i class="fa fa-upload"></i> 
                                @if($this->session->user_login['role'] != 'a01')Upload & @endif Lihat Kondisi</a>

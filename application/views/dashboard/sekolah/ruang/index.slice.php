                    ...
                    @foreach($ruang as $data)
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="min-width: 255px">
                                <a href="{{ base_url('SekolahController/lihatRuang/'.$data->npsn) }}" class="btn btn-sm btn-primary"><i class="fa fa-search mr-2"></i> Lihat Ruang  
                                    @if($this->session->user_login['role'] != 'a01') & Tambah Ruang @endif</a>

...
class Download extends MY_Protectedcontroller
{
 ...
 //    public function laporan_kondisi_sekolah()
	...
	// 		// 		DATA SEKOLAH DASAR NEGERI TAHUN 2019<br>
 ...
 //    					vertical-align: middle;
	...
	// 					<td width="19.5%"rowspan="2">Nama Sekolah</td>
	// 					<td width="11.5%" colspan="2">Kondisi Ruang Kelas</td>
	// 					<td width="11.5%" colspan="4">Kondisi Ruang Kasek</td>
	// 					<td width="11.5%" colspan="4">Kondisi Ruang Guru</td>
	// 					<td width="11.5%" colspan="4">Kondisi Perpustakaan</td>
	// 					<td width="11.5%" colspan="4">Kondisi KM/WC</td>
	// 					<td width="11.5%" colspan="4">Kondisi Laboratorium</td>
	// 					<td width="11.5%" colspan="4">R. Pendukung</td>
	// 				</tr>
	// 				<tr style="font-size: 6pt;">
	// 					<td width="2.5%" >Baik</td>
	// 					<td width="3%" >Rusak Ringan 0-30%</td>
	// 					<td width="3%;" >Rusak Sedang 30-45%</td>
	// 					<td width="3%;">Rusak Berat >45%</td>
	...
	// 		while(1)
	// 		{
	// 			// $kelas = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");
	// 			$kelas_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");
	// 			// var_dump($kelas_ringan->kerusakan_kelas);return;
	// 			$kelas_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");
	// 			$kelas_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");
	// 			$kelas_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");

	// 			$kasek_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Ruang Kasek");
	// 			$kasek_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Ruang Kasek");
	// 			$kasek_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Ruang Kasek");
	// 			$kasek_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Ruang Kasek");

	// 			$guru_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Ruang Guru");
	// 			$guru_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Ruang Guru");
	// 			$guru_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Ruang Guru");
	// 			$guru_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Ruang Guru");

	// 			$perpus_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Perpustakaan");
	// 			$perpus_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Perpustakaan");
	// 			$perpus_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Perpustakaan");
	// 			$perpus_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Perpustakaan");

	// 			$km_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Kamar Mandi");
	// 			$km_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Kamar Mandi");
	// 			$km_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Kamar Mandi");
	// 			$km_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Kamar Mandi");

	// 			$dukung_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Ruang Pendukung");
	// 			$dukung_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Ruang Pendukung");
	// 			$dukung_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Ruang Pendukung");
	// 			$dukung_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Ruang Pendukung");

	// 			$lab_ringan = $this->sekolah->getKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"Laboratorium");
	// 			$lab_sedang = $this->sekolah->getKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"Laboratorium");
	// 			$lab_berat = $this->sekolah->getKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"Laboratorium");
	// 			$lab_baik = $this->sekolah->getKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"Laboratorium");
	// 			// $kasek = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Ruang Kasek");
	// 			// $guru = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Ruang Guru");
	// 			// $perpus = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Perpustakaan");	
	// 			// $km = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Kamar Mandi");	
	// 			// var_dump($kelas->kerusakan_kelas);return;
	// 			$html=$html.
	// 				'<tr>
	// 					<td width="19.5%" class="font-size">'.$data['sekolah'][$loop]->nama_sekolah.' '.$data['sekolah'][$loop]->kecamatan.'</td>

	// 					<td width="2.5%" >'.$kelas_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kelas_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kelas_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kelas_berat->kerusakan_kelas.'</td>

	// 					<td width="2.5%" >'.$kasek_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kasek_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kasek_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$kasek_berat->kerusakan_kelas.'</td>

	// 					<td width="2.5%" >'.$guru_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$guru_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$guru_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$guru_berat->kerusakan_kelas.'</td>
	
	// 					<td width="2.5%" >'.$perpus_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$perpus_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$perpus_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$perpus_berat->kerusakan_kelas.'</td>
	
	// 					<td width="2.5%" >'.$km_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$km_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$km_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$km_berat->kerusakan_kelas.'</td>
						
	// 					<td width="2.5%" >'.$dukung_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$dukung_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$dukung_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$dukung_berat->kerusakan_kelas.'</td>

	// 					<td width="2.5%" >'.$lab_baik->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$lab_ringan->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$lab_sedang->kerusakan_kelas.'</td>
	// 					<td width="3%" >'.$lab_berat->kerusakan_kelas.'</td>
	// 				</tr>';
	// 			$no++;
	// 			$loop++;
	// 			if(($no-1)%$row==0)break;
	...
	public function laporan_kondisi_sekolah()
	{
		...
		// for($i=1;$i<=1;$i++)
		{
			...
			$html = 
				...
				<table width="100%" style="font-size: 8.5pt; color: #000000; text-align:center;">
					<tr>
						...
						<td width="19.5%"rowspan="2">Nama Sekolah</td>
						<td width="11.5%" colspan="2">Kondisi Kantin</td>
						<td width="11.5%" colspan="4">Kondisi UKS</td>
						<td width="11.5%" colspan="4">Kondisi Koperasi</td>
						<td width="11.5%" colspan="4">Kondisi Rumah Dinas</td>
						<td width="11.5%" colspan="4">Kondisi Mushola</td>
					</tr>
					<tr style="font-size: 6pt;">
						<td width="2.5%" >Baik</td>
						<td width="3%" >Rusak Ringan 0-30%</td>
			...
			{
				// $kelas = $this->sekolah->getKategoriKelas($data['sekolah'][$loop]->nama_sekolah,"Ruang Kelas");
				$kelas_ringan = $this->sekolah->agetKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"%anti%");
				// var_dump($kelas_ringan->kerusakan_kelas);return;
				$kelas_sedang = $this->sekolah->agetKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"%anti%");
				$kelas_berat = $this->sekolah->agetKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"%anti%");
				$kelas_baik = $this->sekolah->agetKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"%anti%");

				$kasek_ringan = $this->sekolah->agetKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"%uks%");
				$kasek_sedang = $this->sekolah->agetKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"%uks%");
				$kasek_berat = $this->sekolah->agetKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"%uks%");
				$kasek_baik = $this->sekolah->agetKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"%uks%");

				$guru_ringan = $this->sekolah->agetKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"%opera%");
				$guru_sedang = $this->sekolah->agetKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"%opera%");
				$guru_berat = $this->sekolah->agetKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"%opera%");
				$guru_baik = $this->sekolah->agetKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"%opera%");

				$perpus_ringan = $this->sekolah->agetKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"%dinas%");
				$perpus_sedang = $this->sekolah->agetKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"%dinas%");
				$perpus_berat = $this->sekolah->agetKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"%dinas%");
				$perpus_baik = $this->sekolah->agetKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"%dinas%");

				$km_ringan = $this->sekolah->agetKategoriKelasBaik($data['sekolah'][$loop]->nama_sekolah,"%usho%");
				$km_sedang = $this->sekolah->agetKategoriKelasRingan($data['sekolah'][$loop]->nama_sekolah,"%usho%");
				$km_berat = $this->sekolah->agetKategoriKelasSedang($data['sekolah'][$loop]->nama_sekolah,"%usho%");
				$km_baik = $this->sekolah->agetKategoriKelasBerat($data['sekolah'][$loop]->nama_sekolah,"%usho%");
				...
				$html=$html.
					'<tr>
						<td width="19.5%" class="font-size">'.$data['sekolah'][$loop]->nama_sekolah.'</td>
